...
**/
function displayResults(dailyInventory, glassPrice, dailySales) {
    // calculate results
    var revenue = dailySales * glassPrice;
    var expense = dailyInventory * lemonadeCost;
    var leftOver = dailyInventory - dailySales;
    var profit = revenue - expense;

    // print out the weekly report
    document.getElementById("result").innerHTML += "<p>You sold a total of " + dailySales + " glasses of lemonade this day.</p>";
